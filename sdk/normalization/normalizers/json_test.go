...
func testJSONCreateNormalizer() *jsonNormalizer {
	n, err := newJSONNormalizer(Config{
		Mapping: []MappingConfig{
			...
			{SourceField: "computer_name", EventField: "OriginDNSName"},
			{SourceField: "source_name", EventField: "OriginProcessName"},
			{SourceField: "event_id", EventField: "OriginEventID"},
			{SourceField: "event_data.LogonType", EventField: "RequestMethod"},
			{SourceField: "event_data.TargetUserName", EventField: "RequestUser"},
			{SourceField: "event_data.TargetDomainName", EventField: "RequestUnit"},
			{SourceField: "event_data.AuthenticationPackageName", EventField: "RequestApplicationProtocol"},
